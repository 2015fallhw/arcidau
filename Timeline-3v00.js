...
(function() {
  ...
  Animator = function(initObj, draw, path, options) // pass additional arguments in options object
  {
    var savThis = this,
        i;
    ...
    {
      this.obj = initObj.call(this, this.options);  // call object creation code
    }
    ...
    this.nextFrame = function(t)
    {
      ...
      savThis.pathFn(t, savThis.options);
      savThis.drawFn(savThis.obj, savThis.nextState, savThis.options); // pass the new state
      // swap state pointers
