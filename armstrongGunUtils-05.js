/*==========================================================================*
  Filename: armstrongGunUtils-05.js
  By: Dr A.R.Collins

  JavaScript Armstrong-Frederick gun drawing utilities.
  Requires:
  'CangoSVGtext-3v00.js'
  ...
  28Mar17 Convert to use CangoSVGtext-3v00                               ARC
  08Jul17 Remove genScale to main page, its out of place here            ARC
 *==========================================================================*/

  // exposed globals
  var calcGunDimensions, genGunPartOutlines, genGunSectionedOutlines,
      patternTable,
...
(function()
{
  "use strict";
      ...
      patternTable = {"1":{calibre:2.019, breech:44, reinforce2:33, chase:24},
