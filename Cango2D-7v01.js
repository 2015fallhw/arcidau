...
// ============ Start Here =====================================================
  ...
  Cango2D.prototype.paintText = function(pathObj)
  {
    ...
    this.worldToPixel.reset();   // reset to identity matrix
    this.worldToPixel.applyTransform(scaleMatrix(1, -1));     // flip Y axis, make it world coords
    ...
    fntSz = pathObj.fontSizeWC;                      // fontSizeWC is set in formatText
