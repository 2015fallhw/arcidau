/*============================================================
  ...
  05Apr17 Convert to use Cango-9v02                        ARC
  25Jul17 Convert to use Cango-11v01                       ARC
 =============================================================*/
  ...
  KaiserFIR.prototype.plotCoeffs = function(cvsID)
  {
    ...
    g.gridboxPadding(15, 5, 5, 5);
    g.setWorldCoordsRHC(0, -0.6, this.M, 1.6);
    ...
    g.drawPath(data, {strokeColor:"white", lineWidth:3});
  }
  ...
  KaiserFIR.prototype.plotFreqResp = function(cvsID)
  {
    ...
    g.gridboxPadding(15, 6, 5, 6);
    g.setWorldCoordsRHC(0, yMin, 512*dF, yMax-yMin);
    ...
    g.drawBoxAxes(0, 512*dF, yMin, yMax, {
      ...
      yUnits: "dB",
      title: "Freq Response" });
    g.drawPath(data, {strokeColor: "white"});
  }
